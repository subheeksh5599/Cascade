  ...
  return (
    <svg className="graph-svg" viewBox="0 0 1000 560" preserveAspectRatio="xMidYMid meet"
      ...
      {nodes.map((node) => {
        ...
        const nodeFilter = isActive ? "url(#graphsvg-nodeGlow)" : undefined;
        ...
        return (
          <g key={node.id} style={{ cursor: "pointer", transition: "opacity 0.3s ease" }}>
            ...
            <rect x={node.x} y={node.y} width={NODE_W} height={NODE_H} rx={8}
              ...
              strokeWidth={1.2}
              filter={nodeFilter}
              className={isActive ? "border border-emerald-500/40 shadow-[0_0_15px_rgba(16,185,129,0.15)]" : ""}
            ...
            <rect x={node.x + 9} y={node.y + 10} width={24} height={24} rx={6}
              ...
              stroke={isActive ? colors.border : "rgba(255,255,255,0.05)"}
              strokeWidth={1} />
            <text x={node.x + 21} y={node.y + 26} textAnchor="middle"
              ...
              fill={isActive ? colors.badge : "rgba(255,255,255,0.25)"}>
              {glyph}
            </text>
            ...
            <text x={node.x + 42} y={node.y + 42}
              ...
              fill={isActive ? "rgba(255,255,255,0.45)" : "rgba(255,255,255,0.15)"}>
